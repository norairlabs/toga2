...
namespace TOGA
{
    public partial class MSFSAddProfile : Form
    {
        ...
        private void AddPeripheral_Click(object sender, EventArgs e)
        {
            ...
            string ThisProfilePath = MSFSProfilesPath + ".\\" + NAME.Text.Trim();
        ...
        private void NAME_TextChanged(object sender, EventArgs e)
        {
            ...
            if (Directory.Exists(Path.Combine(MSFSProfilesPath, NAME.Text.Trim())))
            {
